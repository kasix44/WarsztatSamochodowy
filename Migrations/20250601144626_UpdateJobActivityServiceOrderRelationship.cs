...
{
    /// <inheritdoc />
    public partial class UpdateJobActivityServiceOrderRelationship : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "JobActivityServiceOrder",
                columns: table => new
                {
                    JobActivitiesId = table.Column<int>(type: "int", nullable: false),
                    ServiceOrdersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobActivityServiceOrder", x => new { x.JobActivitiesId, x.ServiceOrdersId });
                    table.ForeignKey(
                        name: "FK_JobActivityServiceOrder_JobActivities_JobActivitiesId",
                        column: x => x.JobActivitiesId,
                        principalTable: "JobActivities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobActivityServiceOrder_ServiceOrders_ServiceOrdersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobActivityServiceOrder_ServiceOrdersId",
                table: "JobActivityServiceOrder",
