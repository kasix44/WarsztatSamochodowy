...
namespace WorkshopManager.Migrations
{
    ...
    [Migration("20250601144626_UpdateJobActivityServiceOrderRelationship")]
    partial class UpdateJobActivityServiceOrderRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobActivityServiceOrder", b =>
                {
                    b.Property<int>("JobActivitiesId")
                        .HasColumnType("int");

                    b.Property<int>("ServiceOrdersId")
                        .HasColumnType("int");

                    b.HasKey("JobActivitiesId", "ServiceOrdersId");

                    b.HasIndex("ServiceOrdersId");

                    b.ToTable("JobActivityServiceOrder");
                });
            ...
            modelBuilder.Entity("JobActivityServiceOrder", b =>
                {
                    b.HasOne("WorkshopManager.Models.JobActivity", null)
                        .WithMany()
                        .HasForeignKey("JobActivitiesId")
